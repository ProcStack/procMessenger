 ...
 * Separated from UI logic for clean architecture.
 */
...
class WebSocketManager {
    ...
    connect(serverIp, port) {
        ...
        try {
            ...
            this.onStatusChange("error", `Failed to create WebSocket: ${e.message}`);
            this._scheduleReconnect(serverIp, port);
            return;
        }
        ...
        this.ws.onerror = (event) => {
            ...
            this.onStatusChange("error", "WebSocket error occurred.");
        };
    }
